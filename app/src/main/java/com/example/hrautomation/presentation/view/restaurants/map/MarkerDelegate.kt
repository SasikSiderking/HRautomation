...
import com.example.hrautomation.utils.bitmap.MarkerIconProvider
...
class MultipleMarker(context: Context, latLng: LatLng, buildingId: Long, quantity: String) :
    ...
    override val iconDefault = MarkerIconProvider.provideWithText(
        ...
        quantity,
        Color.valueOf(context.getColor(com.google.android.material.R.color.m3_ref_palette_white))
    )
