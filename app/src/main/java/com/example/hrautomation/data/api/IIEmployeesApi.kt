...
class IIEmployeesApi: IEmployeesApi {
    ...
    val emp2 = EmployeeResponse(1,"Elizabet Bythelook", "Bayliz@mail.ru","HRautomation", "Backend Developer", "amogusamogusamogusamogusamogusamogusvamogusamogusamogusamogusamogusamogus","admin" )
